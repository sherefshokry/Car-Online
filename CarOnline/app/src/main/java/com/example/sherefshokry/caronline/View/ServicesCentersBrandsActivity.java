 ...
 */
public class ServicesCentersBrandsActivity extends AppCompatActivity {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(checkInternetConenction()) {
                    ...
                    final ServicesCentersLink services = new ServicesCentersLink(ServicesCentersBrandsActivity.this);
                    controller.execute(ServicesCentersBrandsActivity.this, services, String.valueOf(position+1));  }
                else {
